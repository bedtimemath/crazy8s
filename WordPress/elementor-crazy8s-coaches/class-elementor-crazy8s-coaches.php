<?php
/**
 * Elementor_Crazy8s_Coaches class.
 *
 * @category   Class
...
/**
 * Main Elementor Coaches Class
 *
 * The init class that runs the Elementor Coaches plugin.
 ...
 */
final class Elementor_Crazy8s_Coaches {
	 ...
	 */
	const MINIMUM_ELEMENTOR_VERSION = '3.27.4'; // latest as of 2025-02-17
	...
	public function i18n() {
		load_plugin_textdomain( 'elementor-crazy8s-coaches' );
	}
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( ELEMENTOR_CRAZY8S_COACHES ) );
