<?php
/**
 * Elementor_BedtimeMath_Teaser class.
 *
 * @category   Class
 ...
 */
 final class Elementor_BedtimeMath_Teaser {
	/**
	 * Plugin Version
	 *
	 * @since 1.0.0
	...
	public function admin_notice_minimum_php_version() {
		...
		return sprintf(
			...
			'Elementor BedtimeMath Teaser',
			'Elementor',
			self::MINIMUM_ELEMENTOR_VERSION
		);
	}
}
// Instantiate Elementor_BedtimeMath_Teaser.
new Elementor_BedtimeMath_Teaser();