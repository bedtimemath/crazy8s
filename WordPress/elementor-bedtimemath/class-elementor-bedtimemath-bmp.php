<?php
/**
 * Elementor_BedtimeMath_BMP class.
 *
 * @category   Class
 ...
 */
 final class Elementor_BedtimeMath_BMP {
	/**
	 * Plugin Version
	 *
	 * @since 1.0.0
	...
	public function admin_notice_minimum_php_version() {
		...
		return sprintf(
			...
			'Elementor BedtimeMath BMP',
			'Elementor',
			self::MINIMUM_ELEMENTOR_VERSION
		);
	}
}
// Instantiate Elementor_BedtimeMath_BMP.
new Elementor_BedtimeMath_BMP();