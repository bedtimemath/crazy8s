<?php
/**
 * Elementor_BedtimeMath_Activity_List class.
 *
 * @category   Class
...
/**
 * Main Elementor BedtimeMath Class
 *
 * The init class that runs the Elementor BedtimeMath plugin.
 ...
 */
 final class Elementor_BedtimeMath_Activity_List {
	/**
	 * Plugin Version
	 *
	 * @since 1.0.0
	...
	public function i18n() {
		load_plugin_textdomain( 'elementor-bedtimemath' );
	}
	/**
	 * Initialize the plugin
	 *
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( ELEMENTOR_BEDTIMEMATH ) );
		return sprintf(
			wp_kses(
			...
			'Elementor Bedtime Math Activity List',
			'Elementor'
		);
	}
	/**
	...
	public function admin_notice_minimum_php_version() {
		...
		return sprintf(
			...
			'Elementor BedtimeMath Activity List',
			'Elementor',
			self::MINIMUM_ELEMENTOR_VERSION
		);
	}
}
// Instantiate Elementor_BedtimeMath_Activity_List.
new Elementor_BedtimeMath_Activity_List();