...
public static class SoftCrowConstants
{
    ...
    public static class Display
    {
        ...
        public const string AnonymousWord = "anonymous";
    ...
    public static class Icons
    {
        ...
        public const string Empty = "<i class=\"fa-regular fa-empty-=set\"></i>";
    ...
    public static class MaxLengths
    {
        ...
        public const int Enormous = 8192;
        public const int Comments = Enormous;
        public const int Description = Enormous;
    }
    ...
    {
        public const string Microsoft = "MicrosoftOidc";
    }
