...
IF NOT EXISTS (
    ...
    WHERE [MigrationId] = N'20241215182207_InitialSetup'
)
BEGIN
...
BEGIN
    CREATE TABLE [RequestedClubs] (
        ...
        CONSTRAINT [FK_RequestedClubs_Requests_RequestId] FOREIGN KEY ([RequestId]) REFERENCES [Requests] ([RequestId])
    );
END;
...
BEGIN
    CREATE INDEX [IX_RequestedClubs_RequestId] ON [RequestedClubs] ([RequestId]);
END;
...
BEGIN
    ...
    VALUES (N'20241215182207_InitialSetup', N'9.0.0');
END;

IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241218192812_AddAddressToRequest'
)
BEGIN
    ALTER TABLE [Requests] ADD [PlaceAddress1] nvarchar(255) NULL;
END;
...
BEGIN
    ALTER TABLE [Requests] ADD [PlaceAddress2] nvarchar(255) NULL;
END;
...
BEGIN
    ALTER TABLE [Requests] ADD [PlaceCity] nvarchar(50) NULL;
END;
...
BEGIN
    ALTER TABLE [Requests] ADD [PlacePostalCode] nvarchar(25) NULL;
END;
...
BEGIN
    ALTER TABLE [Requests] ADD [PlaceState] nvarchar(5) NULL;
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20241218192812_AddAddressToRequest', N'9.0.0');
END;

IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241231173015_AddIdsToUnfinished'
)
BEGIN
    ALTER TABLE [Unfinisheds] ADD [ClubId] int NULL;
END;
...
BEGIN
    ALTER TABLE [Unfinisheds] ADD [PersonId] int NULL;
END;
...
BEGIN
    ALTER TABLE [Unfinisheds] ADD [PlaceId] int NULL;
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20241231173015_AddIdsToUnfinished', N'9.0.0');
END;

IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250103185626_RemoveClubFromUnfinished'
)
BEGIN
    ...
    WHERE ([d].[parent_object_id] = OBJECT_ID(N'[Unfinisheds]') AND [c].[name] = N'ClubId');
    IF @var0 IS NOT NULL EXEC(N'ALTER TABLE [Unfinisheds] DROP CONSTRAINT [' + @var0 + '];');
    ALTER TABLE [Unfinisheds] DROP COLUMN [ClubId];
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20250103185626_RemoveClubFromUnfinished', N'9.0.0');
END;

IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250106185750_AddAddressChangedToUnfinished'
)
BEGIN
    ALTER TABLE [Unfinisheds] ADD [AddressHasChanged] bit NULL;
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20250106185750_AddAddressChangedToUnfinished', N'9.0.0');
END;

IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250115162427_AddFullSlateToRequest'
)
BEGIN
    ALTER TABLE [Requests] ADD [FullSlateAppointmentId] nvarchar(max) NULL;
END;
...
BEGIN
    ALTER TABLE [Requests] ADD [FullSlateClientId] nvarchar(max) NULL;
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20250115162427_AddFullSlateToRequest', N'9.0.0');
END;
