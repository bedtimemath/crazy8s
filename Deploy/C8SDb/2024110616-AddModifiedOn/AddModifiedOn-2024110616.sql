...
BEGIN
    ...
    VALUES (N'20241001163517_InitialSetup', N'8.0.10');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241006223325_UpdateUnfinisheds'
)
BEGIN
    ...
    WHERE ([d].[parent_object_id] = OBJECT_ID(N'[Unfinisheds]') AND [c].[name] = N'SubmittedOn');
    IF @var0 IS NOT NULL EXEC(N'ALTER TABLE [Unfinisheds] DROP CONSTRAINT [' + @var0 + '];');
    ALTER TABLE [Unfinisheds] ALTER COLUMN [SubmittedOn] datetimeoffset NULL;
END;
GO
...
BEGIN
    ALTER TABLE [Unfinisheds] ADD [EndPart01On] datetimeoffset NULL;
END;
GO
...
BEGIN
    ALTER TABLE [Unfinisheds] ADD [EndPart02On] datetimeoffset NULL;
END;
GO
...
BEGIN
    ALTER TABLE [Unfinisheds] ADD [EndPart03On] datetimeoffset NULL;
END;
GO
...
BEGIN
    ALTER TABLE [Unfinisheds] ADD [EndPart04On] datetimeoffset NULL;
END;
GO
...
BEGIN
    ALTER TABLE [Unfinisheds] ADD [EndPart05On] datetimeoffset NULL;
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20241006223325_UpdateUnfinisheds', N'8.0.10');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241008192650_AddHasDoneBefore'
)
BEGIN
    ALTER TABLE [Unfinisheds] ADD [HasDoneBefore] bit NULL;
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20241008192650_AddHasDoneBefore', N'8.0.10');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241008193559_AddHostedBefore'
)
BEGIN
    EXEC sp_rename N'[Unfinisheds].[HasDoneBefore]', N'HasHostedBefore', N'COLUMN';
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20241008193559_AddHostedBefore', N'8.0.10');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241009021052_AddClubsString'
)
BEGIN
    ALTER TABLE [Unfinisheds] ADD [ClubsString] nvarchar(1024) NULL;
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20241009021052_AddClubsString', N'8.0.10');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241009030246_AddWorkshopCodes'
)
BEGIN
    ALTER TABLE [Unfinisheds] ADD [ChosenTimeSlot] datetimeoffset NULL;
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20241009030246_AddWorkshopCodes', N'8.0.10');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241106163941_AddModifiedOn'
)
BEGIN
    ALTER TABLE [WorkshopCodes] ADD [ModifiedOn] datetimeoffset NULL;
END;
GO
...
BEGIN
    ALTER TABLE [Unfinisheds] ADD [ModifiedOn] datetimeoffset NULL;
END;
GO
...
BEGIN
    ALTER TABLE [Skus] ADD [ModifiedOn] datetimeoffset NULL;
END;
GO
...
BEGIN
    ALTER TABLE [Organizations] ADD [ModifiedOn] datetimeoffset NULL;
END;
GO
...
BEGIN
    ALTER TABLE [OrderSkus] ADD [ModifiedOn] datetimeoffset NULL;
END;
GO
...
BEGIN
    ALTER TABLE [Orders] ADD [ModifiedOn] datetimeoffset NULL;
END;
GO
...
BEGIN
    ALTER TABLE [Coaches] ADD [ModifiedOn] datetimeoffset NULL;
END;
GO
...
BEGIN
    ALTER TABLE [Clubs] ADD [ModifiedOn] datetimeoffset NULL;
END;
GO
...
BEGIN
    ALTER TABLE [Applications] ADD [ModifiedOn] datetimeoffset NULL;
END;
GO
...
BEGIN
    ALTER TABLE [ApplicationClubs] ADD [ModifiedOn] datetimeoffset NULL;
END;
GO
...
BEGIN
    ALTER TABLE [Addresses] ADD [ModifiedOn] datetimeoffset NULL;
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20241106163941_AddModifiedOn', N'8.0.10');
END;
GO
