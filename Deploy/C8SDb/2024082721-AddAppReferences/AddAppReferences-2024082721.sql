...
IF NOT EXISTS (
    ...
    WHERE [MigrationId] = N'20240821162627_InitialSetup'
)
BEGIN
...
BEGIN
    ...
    VALUES (N'20240821162627_InitialSetup', N'8.0.8');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20240827211854_AddAppReferences'
)
BEGIN
    ALTER TABLE [Applications] ADD [ReferenceSource] nvarchar(50) NULL;
END;
GO
...
BEGIN
    ALTER TABLE [Applications] ADD [ReferenceSourceOther] nvarchar(512) NULL;
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20240827211854_AddAppReferences', N'8.0.8');
END;
GO
