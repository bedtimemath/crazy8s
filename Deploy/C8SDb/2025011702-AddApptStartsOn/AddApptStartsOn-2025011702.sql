...
IF NOT EXISTS (
    ...
    WHERE [MigrationId] = N'20250116224547_InitialSetup'
)
BEGIN
...
BEGIN
    ...
    VALUES (N'20250116224547_InitialSetup', N'9.0.1');
END;

IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250117021138_AddApptStartsOn'
)
BEGIN
    ALTER TABLE [Requests] ADD [FullSlateAppointmentStartsOn] datetimeoffset NULL;
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20250117021138_AddApptStartsOn', N'9.0.1');
END;
